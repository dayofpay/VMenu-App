    ...
    return (
		...
		<div className="menubar-area style-2 footer-fixed border-top rounded-0">
			<div className="toolbar-inner menubar-nav">
				...
				<Link to={PATH_LIST.APP_CART} className="nav-link">
				...
				<a href="favourite.html" className="nav-link">
					<svg enableBackground="new 0 0 512.001 512.001" height="512" viewBox="0 0 512.001 512.001"
