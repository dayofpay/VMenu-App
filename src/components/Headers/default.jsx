				...
				<div className="container">
					<div className="header-content">
						<div className="left-content">
							<a href="#" className="menu-toggler me-2">
								 <i className="fa-solid fa-bars font-16"></i>
								<svg className="text-dark" xmlns="http://www.w3.org/2000/svg" height="30px"
						...
						<div className="right-content">
							<a href="#;" className="theme-color" data-bs-toggle="offcanvas"
