		...
		<div className="container"> 
			<div className="search-box">
				<a href="search-product.html" className="mb-4 input-group input-group-icon">
					...
					<div className="form-control text-secondary">Потърсете продукт...</div>
				</a>
			</div>
				...
				<ul>
					{categoryData.map((product,index) => (
						...
						<div className="item-content">
							<div className="item-media media media-95"><img src={`http://192.168.0.105:3300/uploads/${JSON.parse(product.item_images)[0]}`} alt="logo"/>
