...
<header className="header">
	...
	<div className="page-content">
		<div className="container">
          ...
          backgroundImage: `url(http://localhost:3300/uploads/${category.category_background_image})`
        }}>
				        ...
				        <h5 className="text-white mb-0">{category.category_name}</h5>
				        <span className="font-18 text-white">{category.itemCount} {GeneratePrefix(category.itemCount)}</span>
				        </Link>
				    </li>
				    ))}
				</ul>
