                    ...
                    <div className="dz-list style-3">
                        <ul>
                            {categoryData.map((product, index) => (
                                <li key={index} className="product-card" style={{ animation: '1s ease-out 0s 1 slideInFromLeft' }}>
                                    <div className="item-content">
                                        <Link to={`/products/${product.item_id}`}>
                                            <div className="item-media">
                                                <img src={`https://v-menu.eu/uploads/${JSON.parse(product.item_images)[0]}`} alt={product.item_name} />
                                            </div>
                                        </Link>
...
const CategoryDetailsGrid = withObjectData(ShowCategoryData);
export default CategoryDetailsGrid;