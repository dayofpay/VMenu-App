...
<section role="tabpanel" className="body current" aria-hidden="false">
            ...
            <div className="card-body">
                <form onSubmit={onSubmit}>
                    <div className="mb-3 input-group">
                        ...
                        <input type="text" className="form-control" onChange={onChange} name={CheckoutKeys.CHECKOUT_NAME}
                            placeholder="Вашето име" required value={values[CheckoutKeys.CHECKOUT_NAME]} />
                    </div>
                    <div className="mb-3 input-group">
                    ...
                    <div className="footer fixed ">
                        <div className="container">
                            <div className="footer-btn d-flex align-items-center"><button className="btn btn-primary flex-1" type="submit">ПОРЪЧАЙ</button>
                            </div>
                        </div>
                    </div>
                </form>
