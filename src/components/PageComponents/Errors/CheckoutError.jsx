		...
		<div className="container">
			<div className="error-page">
				...
				<div className="clearfix">
					...
					<p>Получи се грешка по време на финализирането на поръчката 😞, техническият екип беше уведомен, междувременно вие може да опитате да финализирате поръчката си отново !</p>
				</div>
			</div>
		</div>
	</div>
...
export default ShowCheckoutError;