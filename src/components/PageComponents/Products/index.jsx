			...
			<div className="container">
				<div className="header-content">
					<div className="left-content">
						...
						<h5 className="title mb-0 text-nowrap">Product Detail</h5>
					</div>
                        ...
                        <div className="swiper-slide">
                            <div className="dz-banner-heading">
                                <div className="overlay-black-light">
                                    <img src="/assets/images/food/pic1.png" className="bnr-img" alt="bg-image"/>
                                </div>
                            </div>
                        </div>
                        <div className="swiper-slide">
				...
				<div className="container">
					<div className="company-detail">
						<div className="detail-content">
							<div className="flex-1">
								<h6 className="text-secondary sub-title">FRUITS</h6>
						...
						<ul className="item-inner">
							<li>
								<div className="reviews-info">
									...
									<h6 className="reviews">4.6 (89 reviews)</h6>
								</div>
							</li>
							<li>
					...
					<div className="item-list-2">
						<div className="price">
							...
							<h3 className="sub-title">$5.8 <del>$8.0</del></h3>
						</div>
					...
					<div className="d-flex align-items-center justify-content-between">
						<div className="badge bg-accent badge-lg badge-warning font-w400 px-3">20% OFF DISCOUNT</div>     
					</div>
				</div>
            </div>
		</div> 
